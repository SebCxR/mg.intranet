    ...
    <div class="popupContainer row-fluid">
        <div class="span12"> 
            <div class="row-fluid">
                ...
                {if $SOURCE_MODULE eq 'MGTransports'}
                <span class="row-fluid">
			<span class="recordLabel span pushDown" title="{$SOURCE_RECORD_INSTANCE->getName()}">				
                                 <span class="titleinfo"><b>{vtranslate('LBL_BUILDING_CHAUFFEURS_LIST', $MODULE_NAME)}</b></span>
                                <span class="subject"> <b>{vtranslate($SOURCE_RECORD_INSTANCE->getDisplayValue('subject'),$SOURCE_MODULE)} - </b></span>
				<span class="mgtypetransport"><b>{vtranslate($SOURCE_RECORD_INSTANCE->getDisplayValue('mgtypetransport'), $SOURCE_MODULE)} - </b></span>
                                 <span class="datetransport"><b>{vtranslate($SOURCE_RECORD_INSTANCE->getDisplayValue('datetransport'), $SOURCE_MODULE)}</b></span>
