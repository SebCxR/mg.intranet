...
//SGTODO 
Calendar_CalendarView_Js("InvitedCalendar_InvitedCalendarView_Js",{
	...
	allocateColorsForAllInvitees : function() {
		var calendarfeeds = jQuery('[data-calendar-feed]');
	...
	performCalendarFeedIntiate : function() {
		...
		this.allocateColorsForAllInvitees();
	...
	registerEvents : function() {
		...
		jQuery('[data-widget-url="module=Calendar&view=ViewTypes&mode=getInvitedListForCalendar"]').trigger('click');
		return this;
	}
});
