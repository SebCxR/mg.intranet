...
{strip}
	<span class="pull-right listViewActions">
		...
		<span class="pageNumbers alignTop" data-placement="bottom" >{*
			* ED140822
			*}{if $LISTVIEW_ENTIRES_COUNT}
				{assign var=recordStartRange value=$PAGING_MODEL->getRecordStartRange()}
				{if $recordStartRange gt 1} {$recordStartRange} {vtranslate('LBL_to', $MODULE)} {/if}
