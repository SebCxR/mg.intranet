		...
		<div class="listViewTopMenuDiv noprint">
			...
			<div class="listViewActionsDiv row-fluid">
				<span class="btn-toolbar span4">
					...
					{if $LISTVIEW_BASICACTION->getLabel() eq 'LBL_QUICK_PRINT'}
						<span class="btn-group">
							<img class="cursorPointer alignBottom"
							...
							src="{vimage_path({$LISTVIEW_BASICACTION->get('linkicon')})}" alt="{vtranslate($LISTVIEW_BASICACTION->getLabel(), $MODULE)}"
							title="{vtranslate($LISTVIEW_BASICACTION->getLabel(), $MODULE)}" />
						</span>
					{else}
						<span class="btn-group">
