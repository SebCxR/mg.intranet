...
class PourVoir extends Vtiger_CRMEntity {
	var $table_name = 'vtiger_pourvoir';
	var $table_index= 'pourvoirid';

	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_pourvoircf', 'pourvoirid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_pourvoir', 'vtiger_pourvoircf');
	...
	var $tab_name_index = Array(
		...
		'vtiger_pourvoir' => 'pourvoirid',
		'vtiger_pourvoircf'=>'pourvoirid');
	...
	var $search_fields = Array(
		'LBL_VEHICULE' => array('pourvoir', 'vehicule'),

	);
	var $search_fields_name = Array (
		'LBL_VEHICULE' => 'vehicule',
