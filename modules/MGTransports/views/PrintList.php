...
class MGTransports_PrintList_View extends Vtiger_Index_View {
	...
	function process(Vtiger_Request $request) {
		...
		else { 	$viewer->assign('ORDER_BY', 'datetransport');
			$viewer->assign('SORT_ORDER', 'DESC');
			}
		...
		$viewer->assign('MODULE','PrintList');
		...
		$viewer->view('PrintList.tpl', $source_module);
	}
}