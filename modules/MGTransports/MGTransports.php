...
class MGTransports extends Vtiger_CRMEntity {
	var $table_name = 'vtiger_mgtransports';
	var $table_index= 'mgtransportsid';

	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_mgtransportscf', 'mgtransportsid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_mgtransports', 'vtiger_mgtransportscf');
	...
	var $tab_name_index = Array(
		...
		'vtiger_mgtransports' => 'mgtransportsid',
		'vtiger_mgtransportscf'=>'mgtransportsid');

	/**
	 * Mandatory for Listing (Related listview)
	 */
	var $list_fields = Array (
		'LBL_CONTACT' => array('mgtransports', 'contact'),
		'LBL_DESCRIPTION' => array('mgtransports', 'description'),
		'LBL_DATETRANSPORT' => array('mgtransports', 'datetransport'),
		'LBL_RETOUR' => array('mgtransports', 'retour'),
		'LBL_POTENTIAL' => array('mgtransports', 'potential'),
		'LBL_ACCOUNT' => array('mgtransports', 'account'),
		'LBL_MGTRANSPORTSTATUS' => array('mgtransports', 'mgtransportstatus'),
		'LBL_MGTYPETRANSPORT' => array('mgtransports', 'mgtypetransport'),
		'LBL_SUBJECT' => array('mgtransports', 'subject'),

	);
	var $list_fields_name = Array (
		'LBL_CONTACT' => 'contact',
		'LBL_DESCRIPTION' => 'description',
		'LBL_DATETRANSPORT' => 'datetransport',
		'LBL_RETOUR' => 'retour',
		'LBL_POTENTIAL' => 'potential',
		'LBL_ACCOUNT' => 'account',
		'LBL_MGTRANSPORTSTATUS' => 'mgtransportstatus',
		'LBL_MGTYPETRANSPORT' => 'mgtypetransport',
		'LBL_SUBJECT' => 'subject',
	...
	var $search_fields = Array(
		...
		'LBL_SUBJECT' => array('mgtransports', 'subject'),
		'LBL_RETOUR' => array('mgtransports', 'retour'),
		'LBL_DATEFIN' => array('mgtransports', 'datefin'),
		'LBL_DESCRIPTION' => array('mgtransports', 'description'),
		'LBL_CONTACT' => array('mgtransports', 'contact'),
		'LBL_DATETRANSPORT' => array('mgtransports', 'datetransport'),
