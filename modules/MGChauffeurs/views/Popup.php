...
class MGChauffeurs_Popup_View extends Vtiger_Popup_View {
	
	/*
	 *SG1411
	 * Ajout de headers 'engagement' et 'popupname'
	 * Ajout de BUSYLIST : voir dans modules/Vehicules/models/Module getBusyList(recordid)
