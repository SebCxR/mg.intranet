...
class MGChauffeurs extends Vtiger_CRMEntity {
	var $table_name = 'vtiger_mgchauffeurs';
	var $table_index= 'mgchauffeursid';

	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_mgchauffeurscf', 'mgchauffeursid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_mgchauffeurs', 'vtiger_mgchauffeurscf');
	...
	var $tab_name_index = Array(
		...
		'vtiger_mgchauffeurs' => 'mgchauffeursid',
		'vtiger_mgchauffeurscf'=>'mgchauffeursid');

	/**
	 * Mandatory for Listing (Related listview)
	 */
	var $list_fields = Array (
		'LBL_NAME' => array('mgchauffeurs', 'name'),
		'LBL_PHONE_MOBILE' => array('mgchauffeurs', 'phone_mobile'),
		'LBL_UICOLOR' => array('mgchauffeurs', 'uicolor'),
		'LBL_MGTYPECHAUFFEUR' => array('mgchauffeurs', 'mgtypechauffeur'),

	);
	var $list_fields_name = Array (
		'LBL_NAME' => 'name',
		'LBL_PHONE_MOBILE' => 'phone_mobile',
		'LBL_UICOLOR' => 'uicolor',
		'LBL_MGTYPECHAUFFEUR' => 'mgtypechauffeur',
	...
	var $search_fields = Array(
		'LBL_EMAIL' => array('mgchauffeurs', 'email'),
		'LBL_UICOLOR' => array('mgchauffeurs', 'uicolor'),
		'LBL_MGTYPECHAUFFEUR' => array('mgchauffeurs', 'mgtypechauffeur'),
		'LBL_PHONE_MOBILE' => array('mgchauffeurs', 'phone_mobile'),
		'LBL_NAME' => array('mgchauffeurs', 'name'),
