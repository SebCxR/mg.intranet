...
class Villes extends Vtiger_CRMEntity {
	var $table_name = 'vtiger_villes';
	var $table_index= 'villesid';

	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_villescf', 'villesid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_villes', 'vtiger_villescf');
	...
	var $tab_name_index = Array(
		...
		'vtiger_villes' => 'villesid',
		'vtiger_villescf'=>'villesid');
