...
(function ($, undefined) {
    ...
    MultiSelect2 = clazz(AbstractSelect2, {
        ...
        unselect: function (selected) {
            ...
            if (selected.length === 0) {
                throw "Argument invalide : " + selected + ". doit être .select2-search-choice";
            }
    ...
    $.fn.select2.defaults = {
        ...
        formatNoMatches: function () { return "Aucune piste trouvée"; },
        formatInputTooShort: function (input, min) { return "Entrer encore " + (min - input.length) + " caractères"; },
        formatSelectionTooBig: function (limit) { return "Vous ne pouvez selectionner plus de " + limit + " item" + (limit == 1 ? "" : "s"); },
        formatLoadMore: function (pageNumber) { return "Chargement de davantage de résultats..."; },
